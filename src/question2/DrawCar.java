...
/**
 * main method for illustrating how these Shapes can be assembled into the shape of a Car
 *
 */
public class DrawCar {
	...
	public static void main(String[] args) {
		...
		//get the area of the car shape
		System.out.println(car.getOverallArea());
		
		//get the number of shapes in the car shape
		System.out.println(car.getNumShapes());
